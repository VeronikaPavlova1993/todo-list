...
//В проекте использовала динамическую стилизацию (через обект).
// Гибкий инструмент, можно общие константы (напрмер, цвета) записать в переменную и переиспользовать, удобно менять значения
// Можно реализовывать функции, в зависимости от события менять стилизацию
const styleDiv = {
